...
https://www.codewars.com/kata/55e6f5e58f7817808e00002e
    ...
    Examples:
        1 - m = 371 -> 37 - (2x1) -> 37 - 2 = 35 ; thus, since 35 is divisible by 7, 371 is divisible by 7.

        The number of steps to get the result is 1.

        2 - m = 1603 -> 160 - (2 x 3) -> 154 -> 15 - 8 = 7 and 7 is divisible by 7.

        3 - m = 372 -> 37 - (2x2) -> 37 - 4 = 33 ; thus, since 33 is not divisible by 7, 372 is not divisible by 7.
    ...
    Task:
        ...
        an array (or a pair, depending on the language) of numbers, the first being the last number m 
